...
Gerado em: `2026-07-28T15:59:09.204105`
...
```text
## main...origin/main
 M migrations/versions/1f19757f07c6_create_roles_table.py
 M src/api/routes/__init__.py
 M src/main.py
 M src/models/part.py
 M src/repositories/part_repository.py
 M src/services/part_service.py
...
?? tests/services/test_part_service.py
```

## Últimos commits

```text
a2003f2 (HEAD -> main, origin/main, origin/HEAD) feat: implementa gerenciamento de contatos de fornecedores
...
661daad feat: add parts and supplier database models
f11d47b feat: add roles and users database models
```
...
app = FastAPI(
    title="SIGC",
    description="Sistema Integrado de GestÃ£o de Cascos",
    version="0.1.0"
)
...
def root():
    return {
        "sistema": "SIGC",
        "mensagem": "Sistema Integrado de GestÃ£o de Cascos em funcionamento.",
        "versao": "0.1.0"
    }
...
========================================
ARQUIVO: src\api\routes\purchase_tracking_route.py
========================================
...
def get_purchase_tracking_service(
    ...
    """
    Monta o Service com suas dependÃªncias.

    A rota nÃ£o cria consultas diretamente. Ela recebe uma sessÃ£o,
...
def get_purchase_tracking(
    ...
    try:
        ...
        if message == "Compra nÃ£o encontrada.":
            raise HTTPException(
...
========================================
ARQUIVO: src\api\routes\__init__.py
========================================

"""
Rotas HTTP da aplicaÃ§Ã£o.
"""
...
========================================
ARQUIVO: src\database\__init__.py
========================================



========================================
ARQUIVO: src\dtos\customer_return_dto.py
========================================



========================================
ARQUIVO: src\dtos\outbound_dto.py
========================================



========================================
ARQUIVO: src\dtos\purchase_tracking.py
========================================
...
class PurchaseItemTrackingDTO:
    """VisÃ£o consolidada do ciclo de um item de compra."""
...
class PurchaseTrackingDTO:
    """VisÃ£o consolidada de uma compra e de seus itens."""
...
========================================
ARQUIVO: src\dtos\purchase_tracking_dto.py
========================================
...
========================================
ARQUIVO: src\dtos\supplier_return_dto.py
========================================



========================================
ARQUIVO: src\dtos\__init__.py
========================================

"""
Data Transfer Objects (DTOs).

ResponsÃ¡vel por transportar dados entre as camadas da aplicaÃ§Ã£o,
...
========================================
ARQUIVO: src\models\audit_log.py
========================================
...
========================================
ARQUIVO: src\models\core_movement.py
========================================
...
========================================
ARQUIVO: src\models\customer_return.py
========================================
...
========================================
ARQUIVO: src\models\customer_return_allocation.py
========================================
...
========================================
ARQUIVO: src\models\customer_return_item.py
========================================
...
========================================
ARQUIVO: src\models\outbound.py
========================================
...
========================================
ARQUIVO: src\models\outbound_item.py
========================================
...
========================================
ARQUIVO: src\models\outbound_purchase_allocation.py
========================================
...
========================================
ARQUIVO: src\models\purchase.py
========================================
...
========================================
ARQUIVO: src\models\purchase_item.py
========================================
...
========================================
ARQUIVO: src\models\supplier.py
========================================
...
========================================
ARQUIVO: src\models\supplier_contact.py
========================================
...
========================================
ARQUIVO: src\models\supplier_return.py
========================================
...
========================================
ARQUIVO: src\models\supplier_return_item.py
========================================
...
========================================
ARQUIVO: src\models\transfer_item.py
========================================
...
========================================
ARQUIVO: src\queries\customer_return_query.py
========================================



========================================
ARQUIVO: src\queries\dashboard_query.py
========================================



========================================
ARQUIVO: src\queries\purchase_query.py
========================================



========================================
ARQUIVO: src\queries\purchase_tracking_query.py
========================================
...
class PurchaseTrackingQuery:
    """Monta visÃµes de acompanhamento sem alterar o banco."""
    ...
    def _get_customer_returned_quantities(
        ...
        """
        Redistribui as devoluÃ§Ãµes de clientes pelas origens FIFO
...
========================================
ARQUIVO: src\queries\supplier_return_query.py
========================================



========================================
ARQUIVO: src\queries\__init__.py
========================================
...
========================================
ARQUIVO: src\repositories\audit_log_repository.py
========================================
...
class AuditLogRepository:
    """ResponsÃ¡vel pela persistÃªncia do histÃ³rico de auditoria."""
...
========================================
ARQUIVO: src\repositories\core_movement_repository.py
========================================
...
class CoreMovementRepository:
    """ResponsÃ¡vel pela persistÃªncia do histÃ³rico de movimentaÃ§Ãµes."""
...
========================================
ARQUIVO: src\repositories\customer_return_allocation_repository.py
========================================
...
class CustomerReturnAllocationRepository:
    """ResponsÃ¡vel pela persistÃªncia das alocaÃ§Ãµes de devoluÃ§Ã£o."""
...
========================================
ARQUIVO: src\repositories\customer_return_item_repository.py
========================================
...
class CustomerReturnItemRepository:
    """ResponsÃ¡vel pela persistÃªncia dos itens de devoluÃ§Ã£o."""
...
========================================
ARQUIVO: src\repositories\customer_return_repository.py
========================================
...
class CustomerReturnRepository:
    """ResponsÃ¡vel pela persistÃªncia de devoluÃ§Ãµes de clientes."""
...
========================================
ARQUIVO: src\repositories\outbound_item_repository.py
========================================
...
class OutboundItemRepository:
    """ResponsÃ¡vel pela persistÃªncia dos itens de saÃ­da."""
...
========================================
ARQUIVO: src\repositories\outbound_purchase_allocation_repository.py
========================================
...
class OutboundPurchaseAllocationRepository:
    """ResponsÃ¡vel pela persistÃªncia das alocaÃ§Ãµes de saÃ­da."""
...
========================================
ARQUIVO: src\repositories\outbound_repository.py
========================================
...
class OutboundRepository:
    """ResponsÃ¡vel pela persistÃªncia de saÃ­das."""
...
========================================
ARQUIVO: src\repositories\part_repository.py
========================================
...
class PartRepository:
    """ResponsÃ¡vel pela persistÃªncia de peÃ§as."""
...
========================================
ARQUIVO: src\repositories\purchase_item_repository.py
========================================
...
class PurchaseItemRepository:
    """ResponsÃ¡vel pela persistÃªncia dos itens de compra."""
...
========================================
ARQUIVO: src\repositories\purchase_repository.py
========================================
...
class PurchaseRepository:
    """ResponsÃ¡vel pela persistÃªncia de compras."""
...
========================================
ARQUIVO: src\repositories\role_repository.py
========================================
...
class RoleRepository:
    """ResponsÃ¡vel pela persistÃªncia de perfis de acesso."""
...
========================================
ARQUIVO: src\repositories\supplier_contact_repository.py
========================================
...
class SupplierContactRepository:
    """ResponsÃ¡vel pela persistÃªncia de contatos de fornecedores."""
...
========================================
ARQUIVO: src\repositories\supplier_repository.py
========================================
...
class SupplierRepository:
    """ResponsÃ¡vel pela persistÃªncia de fornecedores."""
...
========================================
ARQUIVO: src\repositories\supplier_return_item_repository.py
========================================
...
class SupplierReturnItemRepository:
    """ResponsÃ¡vel pela persistÃªncia dos itens das remessas."""
...
========================================
ARQUIVO: src\repositories\supplier_return_repository.py
========================================
...
class SupplierReturnRepository:
    """ResponsÃ¡vel pela persistÃªncia das remessas aos fornecedores."""
...
========================================
ARQUIVO: src\repositories\transfer_item_repository.py
========================================
...
class TransferItemRepository:
    """ResponsÃ¡vel pela persistÃªncia dos itens de transferÃªncia."""
...
========================================
ARQUIVO: src\repositories\transfer_repository.py
========================================
...
class TransferRepository:
    """ResponsÃ¡vel pela persistÃªncia de transferÃªncias internas."""
...
class UserRepository:
    """ResponsÃ¡vel pela persistÃªncia de usuÃ¡rios."""
...
========================================
ARQUIVO: src\repositories\__init__.py
========================================



========================================
ARQUIVO: src\schemas\purchase_tracking_schema.py
========================================
...
========================================
ARQUIVO: src\schemas\__init__.py
========================================



========================================
ARQUIVO: src\security\password.py
========================================
...
========================================
ARQUIVO: src\security\__init__.py
========================================



========================================
ARQUIVO: src\services\customer_return_service.py
========================================
...
class CustomerReturnService:
    """Regras de negÃ³cio relacionadas a devoluÃ§Ãµes de clientes."""
    ...
    def create_customer_return(
        ...
        if not return_type.strip():
            raise ValueError(
                "O tipo de devoluÃ§Ã£o Ã© obrigatÃ³rio."
            )

        if not reference_number.strip():
            raise ValueError(
                "O nÃºmero de referÃªncia Ã© obrigatÃ³rio."
            )

        if not customer_name.strip():
            raise ValueError(
                "O nome do cliente Ã© obrigatÃ³rio."
            )
    ...
    def add_item(
        ...
        if customer_return is None:
            raise ValueError(
                "DevoluÃ§Ã£o do cliente nÃ£o encontrada."
            )
        ...
        if not outbound_items:
            raise ValueError(
                "NÃ£o existem saÃ­das registradas para esta peÃ§a."
            )
        ...
        if quantity > available_for_return:
            raise ValueError(
                "A quantidade devolvida Ã© maior que a "
                "quantidade disponÃ­vel para devoluÃ§Ã£o."
            )
        ...
        if remaining_quantity > 0:
            raise ValueError(
                "NÃ£o foi possÃ­vel alocar toda a quantidade "
                "devolvida Ã s saÃ­das existentes."
            )
...
========================================
ARQUIVO: src\services\outbound_service.py
========================================
...
class OutboundService:
    """Regras de negÃ³cio relacionadas a saÃ­das."""
    ...
    def create_outbound(
        ...
        if not destination_type.strip():
            raise ValueError(
                "O tipo de destino Ã© obrigatÃ³rio."
            )
        ...
        if work_order_number is None and (
            ...
            raise ValueError(
                "A saÃ­da deve possuir uma ordem de serviÃ§o "
    ...
    def add_item(
        ...
        if quantity <= 0:
            raise ValueError(
                "A quantidade da saÃ­da deve ser maior que zero."
            )
        ...
        if total_available < quantity:
            raise ValueError(
                "Quantidade disponÃ­vel insuficiente "
                "para a saÃ­da."
            )
...
========================================
ARQUIVO: src\services\part_service.py
========================================
...
class PartService:
    """Regras de negÃ³cio relacionadas a peÃ§as."""
    ...
    def create(
        ...
        if not normalized_code:
            raise ValueError(
                "O cÃ³digo da peÃ§a Ã© obrigatÃ³rio."
            )

        if not normalized_name:
            raise ValueError(
                "O nome da peÃ§a Ã© obrigatÃ³rio."
            )
        ...
        if existing_part is not None:
            raise ValueError(
                "JÃ¡ existe uma peÃ§a com este cÃ³digo."
            )
...
========================================
ARQUIVO: src\services\purchase_service.py
========================================
...
class PurchaseService:
    """Regras de negÃ³cio relacionadas a compras."""
...
========================================
ARQUIVO: src\services\purchase_tracking_service.py
========================================
...
class PurchaseTrackingService:
    ...
    def get_purchase_tracking(
        ...
        if tracking is None:
            raise ValueError("Compra nÃ£o encontrada.")

        return tracking


========================================
ARQUIVO: src\services\role_service.py
========================================
...
class RoleService:
    """Regras de negÃ³cio relacionadas a perfis de acesso."""
    ...
    def create(
        ...
        if not normalized_name:
            raise ValueError(
                "O nome do perfil Ã© obrigatÃ³rio."
            )
        ...
        if existing_role is not None:
            raise ValueError(
                "JÃ¡ existe um perfil com este nome."
            )
...
========================================
ARQUIVO: src\services\supplier_contact_service.py
========================================
...
class SupplierContactService:
    """Regras de negÃ³cio relacionadas aos contatos de fornecedores."""
    ...
    def create(
        ...
        if not normalized_name:
            raise ValueError(
                "O nome do contato Ã© obrigatÃ³rio."
            )
...
========================================
ARQUIVO: src\services\supplier_return_service.py
========================================
...
class SupplierReturnService:
    """Regras de negÃ³cio das remessas de cascos aos fornecedores."""
    ...
    def create_supplier_return(
        ...
        if not normalized_invoice_number:
            raise ValueError(
                "O nÃºmero da Nota Fiscal de Simples "
                "Remessa Ã© obrigatÃ³rio."
            )

        if not issue_date.strip():
            raise ValueError(
                "A data da remessa Ã© obrigatÃ³ria."
            )
        ...
        if existing_supplier_return is not None:
            raise ValueError(
                "JÃ¡ existe uma remessa cadastrada com "
                "este nÃºmero de Nota Fiscal."
            )
    ...
    def add_item(
        ...
        if supplier_return is None:
            raise ValueError(
                "Remessa ao fornecedor nÃ£o encontrada."
            )
        ...
        if purchase_item is None:
            raise ValueError(
                "Item de compra nÃ£o encontrado."
            )
        ...
        if existing_item is not None:
            raise ValueError(
                "Este item de compra jÃ¡ foi adicionado "
                "Ã  remessa."
            )
        ...
        if purchase is None:
            raise ValueError(
                "Compra de origem nÃ£o encontrada."
            )

        if purchase.supplier_id != supplier_return.supplier_id:
            raise ValueError(
                "O item de compra nÃ£o pertence ao fornecedor "
                "da remessa."
            )
        ...
        if quantity > available_quantity:
            raise ValueError(
                "A quantidade remetida Ã© maior que a "
                "quantidade disponÃ­vel para remessa. "
                f"Quantidade mÃ¡xima permitida: "
    ...
    def _get_customer_returned_quantity(
        ...
        """
        Calcula quantos cascos jÃ¡ retornaram dos clientes
        para uma origem especÃ­fica de compra.

        A devoluÃ§Ã£o do cliente estÃ¡ ligada ao OutboundItem.
        Portanto, a quantidade devolvida Ã© redistribuÃ­da
        ...
        for existing_item in existing_items:
            ...
            if existing_purchase_item is None:
                raise ValueError(
                    ...
                    "origem de compra invÃ¡lida."
                )

            if existing_purchase_item.purchase_id != purchase_id:
                raise ValueError(
                    "Todos os itens de uma remessa devem "
                    "pertencer Ã  mesma Nota Fiscal de compra."
                )


========================================
ARQUIVO: src\services\supplier_service.py
========================================
...
class SupplierService:
    """Regras de negÃ³cio relacionadas a fornecedores."""
    ...
    def create(
        ...
        if not normalized_name:
            raise ValueError(
                "O nome do fornecedor Ã© obrigatÃ³rio."
            )
        ...
        if normalized_document:
            ...
            if existing_supplier is not None:
                raise ValueError(
                    "JÃ¡ existe um fornecedor com este documento."
                )
...
========================================
ARQUIVO: src\services\transfer_service.py
========================================
...
class TransferService:
    """Regras de negÃ³cio relacionadas Ã s transferÃªncias."""
...
class UserService:
    ...
    def create(
        ...
        if not normalized_email:
            raise ValueError(
                "O e-mail Ã© obrigatÃ³rio."
            )

        if not password:
            raise ValueError(
                "A senha Ã© obrigatÃ³ria."
            )
        ...
        if existing_username is not None:
            raise ValueError(
                "JÃ¡ existe um usuÃ¡rio com este username."
            )
...
========================================
ARQUIVO: src\services\__init__.py
========================================
...
========================================
ARQUIVO: tests\services\test_purchase_tracking_service.py
========================================
