...
Gerado em: `2026-07-30T15:25:50.149378`
...
```text
55e353a (HEAD -> main, origin/main, origin/HEAD) feat(customer-return): implement customer return module
2b882af feat: implementa módulo completo de saídas
...
## `src\api\routes\customer_return_route.py`
...
## `src\schemas\customer_return_schema.py`
...
## `tests\api\test_customer_return_route.py`
...
## `tests\services\test_customer_return_service.py`
